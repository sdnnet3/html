			...
			<div id="wrapper" class="fade-in">
				...
				<!-- Intro -->
					<div id="intro">
						...
						- by -<br />
						Clayton Hutton</h1>
						<p>A Wandering Photophrapher's Journey</p>
						<p><a href="https://www.Instagram.com/Perspectiveperfection">@Perspective Perfection</a></p>
				...
				<!-- Header -->
					<header id="header">
					<a href="home.php" class="logo"> <img style="width:150px;" src="images/logo.png" /></a>
					</header>
						...
						<!-- Footer -->
							<footer>
								<div class="pagination">
									...
									<a href="home.php" class="page active">1</a>
